...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/enova/ars.enova.com.br/log/adm_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/enova/ars.enova.com.br/cache/adm/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/enova/ars.enova.com.br/apps/adm/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/enova/ars.enova.com.br/cache/adm/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/enova/ars.enova.com.br/apps/adm/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'mail.enova.com.br',
      'port' => 587,
      'encryption' => NULL,
      'username' => 'jefferson@enova.com.br',
      'password' => 'serion',
    ),
  ),
))));
