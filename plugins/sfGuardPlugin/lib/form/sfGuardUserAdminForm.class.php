...
class sfGuardUserAdminForm extends BasesfGuardUserForm
{
  ...
  public function configure()
  {
    ...
    $this->validatorSchema['password']->setMessage('min_length', 'Por favor, digite uma <strong>SENHA</strong> de no mínimo 6 caracteres.');
    $this->widgetSchema['password_again'] = new sfWidgetFormInputPassword();
    $this->validatorSchema['password_again'] = clone $this->validatorSchema['password'];

    $this->widgetSchema->moveField('password_again', 'after', 'password');

    $this->mergePostValidator(new sfValidatorSchemaCompare('password', sfValidatorSchemaCompare::EQUAL, 'password_again', array(), array('invalid' => 'As senhas informadas devem ser iguais.')));
