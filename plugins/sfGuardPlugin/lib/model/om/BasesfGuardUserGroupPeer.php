...
abstract class BasesfGuardUserGroupPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::GROUP_ID, self::USER_ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::GROUP_ID => 0, self::USER_ID => 1, ),
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				$criterion = $criteria->getNewCriterion(sfGuardUserGroupPeer::GROUP_ID, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(sfGuardUserGroupPeer::USER_ID, $value[1]));
	...
	public static function retrieveByPK($group_id, $user_id, PropelPDO $con = null) {
		$key = serialize(array((string) $group_id, (string) $user_id));
 		if (null !== ($obj = sfGuardUserGroupPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
