...
abstract class BasesfGuardUserPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in SystematicReviewPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		...
		// invalidate objects in SystematicReviewUserPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		SystematicReviewUserPeer::clearInstancePool();

		// invalidate objects in StudyPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		...
		// invalidate objects in QuestionnairePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		...
		// invalidate objects in RslCriteriaPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		...
		// invalidate objects in RslResultPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		...
		// invalidate objects in DataExtractionPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		...
		// invalidate objects in AccessTokenPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related SystematicReview objects
			$criteria = new Criteria(SystematicReviewPeer::DATABASE_NAME);
			
			$criteria->add(SystematicReviewPeer::CREATED_BY, $obj->getId());
			$affectedRows += SystematicReviewPeer::doDelete($criteria, $con);

			// delete related SystematicReview objects
			$criteria = new Criteria(SystematicReviewPeer::DATABASE_NAME);
			
			$criteria->add(SystematicReviewPeer::UPDATED_BY, $obj->getId());
			$affectedRows += SystematicReviewPeer::doDelete($criteria, $con);

			// delete related SystematicReview objects
			$criteria = new Criteria(SystematicReviewPeer::DATABASE_NAME);
			
			$criteria->add(SystematicReviewPeer::DELETED_BY, $obj->getId());
			$affectedRows += SystematicReviewPeer::doDelete($criteria, $con);

			// delete related SystematicReviewUser objects
			$criteria = new Criteria(SystematicReviewUserPeer::DATABASE_NAME);
			
			$criteria->add(SystematicReviewUserPeer::USER_ID, $obj->getId());
			$affectedRows += SystematicReviewUserPeer::doDelete($criteria, $con);

			// delete related Study objects
			$criteria = new Criteria(StudyPeer::DATABASE_NAME);
			
			$criteria->add(StudyPeer::CASTING_VOTE, $obj->getId());
			$affectedRows += StudyPeer::doDelete($criteria, $con);

			// delete related Study objects
			$criteria = new Criteria(StudyPeer::DATABASE_NAME);
			
			$criteria->add(StudyPeer::CREATED_BY, $obj->getId());
			$affectedRows += StudyPeer::doDelete($criteria, $con);

			// delete related Study objects
			$criteria = new Criteria(StudyPeer::DATABASE_NAME);
			
			$criteria->add(StudyPeer::UPDATED_BY, $obj->getId());
			$affectedRows += StudyPeer::doDelete($criteria, $con);

			// delete related Study objects
			$criteria = new Criteria(StudyPeer::DATABASE_NAME);
			
			$criteria->add(StudyPeer::DELETED_BY, $obj->getId());
			$affectedRows += StudyPeer::doDelete($criteria, $con);

			// delete related Questionnaire objects
			$criteria = new Criteria(QuestionnairePeer::DATABASE_NAME);
			
			$criteria->add(QuestionnairePeer::CREATED_BY, $obj->getId());
			$affectedRows += QuestionnairePeer::doDelete($criteria, $con);

			// delete related Questionnaire objects
			$criteria = new Criteria(QuestionnairePeer::DATABASE_NAME);
			
			$criteria->add(QuestionnairePeer::UPDATED_BY, $obj->getId());
			$affectedRows += QuestionnairePeer::doDelete($criteria, $con);

			// delete related Questionnaire objects
			$criteria = new Criteria(QuestionnairePeer::DATABASE_NAME);
			
			$criteria->add(QuestionnairePeer::DELETED_BY, $obj->getId());
			$affectedRows += QuestionnairePeer::doDelete($criteria, $con);

			// delete related Question objects
			$criteria = new Criteria(QuestionPeer::DATABASE_NAME);
			
			$criteria->add(QuestionPeer::CREATED_BY, $obj->getId());
			$affectedRows += QuestionPeer::doDelete($criteria, $con);

			// delete related Question objects
			$criteria = new Criteria(QuestionPeer::DATABASE_NAME);
			
			$criteria->add(QuestionPeer::UPDATED_BY, $obj->getId());
			$affectedRows += QuestionPeer::doDelete($criteria, $con);

			// delete related Question objects
			$criteria = new Criteria(QuestionPeer::DATABASE_NAME);
			
			$criteria->add(QuestionPeer::DELETED_BY, $obj->getId());
			$affectedRows += QuestionPeer::doDelete($criteria, $con);

			// delete related Answer objects
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
			
			$criteria->add(AnswerPeer::CREATED_BY, $obj->getId());
			$affectedRows += AnswerPeer::doDelete($criteria, $con);

			// delete related Answer objects
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
			
			$criteria->add(AnswerPeer::UPDATED_BY, $obj->getId());
			$affectedRows += AnswerPeer::doDelete($criteria, $con);

			// delete related Answer objects
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
			
			$criteria->add(AnswerPeer::DELETED_BY, $obj->getId());
			$affectedRows += AnswerPeer::doDelete($criteria, $con);

			// delete related RslCriteria objects
			$criteria = new Criteria(RslCriteriaPeer::DATABASE_NAME);
			
			$criteria->add(RslCriteriaPeer::CREATED_BY, $obj->getId());
			$affectedRows += RslCriteriaPeer::doDelete($criteria, $con);

			// delete related RslCriteria objects
			$criteria = new Criteria(RslCriteriaPeer::DATABASE_NAME);
			
			$criteria->add(RslCriteriaPeer::UPDATED_BY, $obj->getId());
			$affectedRows += RslCriteriaPeer::doDelete($criteria, $con);

			// delete related RslCriteria objects
			$criteria = new Criteria(RslCriteriaPeer::DATABASE_NAME);
			
			$criteria->add(RslCriteriaPeer::DELETED_BY, $obj->getId());
			$affectedRows += RslCriteriaPeer::doDelete($criteria, $con);

			// delete related RslResult objects
			$criteria = new Criteria(RslResultPeer::DATABASE_NAME);
			
			$criteria->add(RslResultPeer::CREATED_BY, $obj->getId());
			$affectedRows += RslResultPeer::doDelete($criteria, $con);

			// delete related RslResult objects
			$criteria = new Criteria(RslResultPeer::DATABASE_NAME);
			
			$criteria->add(RslResultPeer::UPDATED_BY, $obj->getId());
			$affectedRows += RslResultPeer::doDelete($criteria, $con);

			// delete related RslResult objects
			$criteria = new Criteria(RslResultPeer::DATABASE_NAME);
			
			$criteria->add(RslResultPeer::DELETED_BY, $obj->getId());
			$affectedRows += RslResultPeer::doDelete($criteria, $con);

			// delete related Job objects
			$criteria = new Criteria(JobPeer::DATABASE_NAME);
			
			$criteria->add(JobPeer::USER_ID, $obj->getId());
			$affectedRows += JobPeer::doDelete($criteria, $con);

			// delete related Job objects
			$criteria = new Criteria(JobPeer::DATABASE_NAME);
			
			$criteria->add(JobPeer::FINISHED_BY, $obj->getId());
			$affectedRows += JobPeer::doDelete($criteria, $con);

			// delete related DataExtraction objects
			$criteria = new Criteria(DataExtractionPeer::DATABASE_NAME);
			
			$criteria->add(DataExtractionPeer::CREATED_BY, $obj->getId());
			$affectedRows += DataExtractionPeer::doDelete($criteria, $con);

			// delete related DataExtraction objects
			$criteria = new Criteria(DataExtractionPeer::DATABASE_NAME);
			
			$criteria->add(DataExtractionPeer::UPDATED_BY, $obj->getId());
			$affectedRows += DataExtractionPeer::doDelete($criteria, $con);

			// delete related DataExtraction objects
			$criteria = new Criteria(DataExtractionPeer::DATABASE_NAME);
			
			$criteria->add(DataExtractionPeer::DELETED_BY, $obj->getId());
			$affectedRows += DataExtractionPeer::doDelete($criteria, $con);

			// delete related AccessToken objects
			$criteria = new Criteria(AccessTokenPeer::DATABASE_NAME);
			
			$criteria->add(AccessTokenPeer::USER_ID, $obj->getId());
			$affectedRows += AccessTokenPeer::doDelete($criteria, $con);
