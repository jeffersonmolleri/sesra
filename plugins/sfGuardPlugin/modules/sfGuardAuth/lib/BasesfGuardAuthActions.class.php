...
class BasesfGuardAuthActions extends sfActions
{
  ...
  public function executeCreateUser(sfWebRequest $request)
  {
    ...
    $user = $request->getParameter($this->form->getName());
    ...
    $profile = sfGuardUserProfilePeer::doSelect($c);
	    ...
	    $this->form->bind($user, $request->getFiles($this->form->getName()));
  ...
  public function executeSignin(sfWebRequest $request)
  {
    ...
    if ($request->isMethod('post'))
    {
      ...
      if ($this->form->isValid())
      {
        ...
        // or to the referer
        // or to the homepage
        $referer = $request->getHttpHeader('referer');
        $signinUrl = sfConfig::get('app_sf_guard_plugin_success_signin_url', empty($referer) ? '@homepage' : $referer);
