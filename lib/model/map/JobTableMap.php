...
class JobTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setPrimaryKeyMethodInfo('jobs_id_seq');
		// columns
		$this->addPrimaryKey('ID', 'Id', 'INTEGER', true, null, null);
		$this->addColumn('DATE', 'Date', 'TIMESTAMP', false, null, null);
		$this->addColumn('DESCRIPTION', 'Description', 'LONGVARCHAR', false, null, null);
		$this->addForeignKey('ACTIVITY_ID', 'ActivityId', 'INTEGER', 'activities', 'ID', false, null, null);
		...
		$this->addForeignKey('FINISHED_BY', 'FinishedBy', 'INTEGER', 'sf_guard_user', 'ID', true, null, null);
		// validators
	} // initialize()
    ...
    $this->addRelation('Protocol', 'Protocol', RelationMap::MANY_TO_ONE, array('protocol_id' => 'id', ), null, null);
    $this->addRelation('sfGuardUserRelatedByFinishedBy', 'sfGuardUser', RelationMap::MANY_TO_ONE, array('finished_by' => 'id', ), 'CASCADE', null);
	} // buildRelations()
