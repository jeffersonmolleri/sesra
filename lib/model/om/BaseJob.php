...
abstract class BaseJob extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the finished_by field.
	 * @var        int
	 */
	protected $finished_by;
	 ...
	 * @var        sfGuardUser
	 */
	protected $asfGuardUserRelatedByFinishedBy;
	...
	/**
	 * Get the [finished_by] column value.
	 * 
	 * @return     int
	 */
	...
	public function setDate($v)
	{
		...
		if ( $this->date !== null || $dt !== null ) {
			...
			$currNorm = ($this->date !== null && $tmpDt = new DateTime($this->date)) ? $tmpDt->format('Y-m-d\\TH:i:sO') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d\\TH:i:sO') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->date = ($dt ? $dt->format('Y-m-d\\TH:i:sO') : null);
	...
	public function setActivityId($v)
	{
		...
		if ($this->activity_id !== $v) {
			$this->activity_id = $v;
			$this->modifiedColumns[] = JobPeer::ACTIVITY_ID;
		}
	...
	public function setProtocolId($v)
	{
		...
		if ($this->protocol_id !== $v) {
			$this->protocol_id = $v;
			$this->modifiedColumns[] = JobPeer::PROTOCOL_ID;
		}
	...
	public function setFinishedAt($v)
	{
		...
		if ( $this->finished_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = JobPeer::FINISHED_AT;
			}
		} // if either are not null
	...
	/**
	 * Set the value of [finished_by] column.
	 * 
	 * @param      int $v new value
	 * @return     Job The current object (for fluent API support)
	 */
	public function setFinishedBy($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->finished_by !== $v) {
			$this->finished_by = $v;
			$this->modifiedColumns[] = JobPeer::FINISHED_BY;
		}

		if ($this->asfGuardUserRelatedByFinishedBy !== null && $this->asfGuardUserRelatedByFinishedBy->getId() !== $v) {
			$this->asfGuardUserRelatedByFinishedBy = null;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->protocol_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->finished_at = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->finished_by = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = JobPeer::NUM_COLUMNS - JobPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->asfGuardUserRelatedByFinishedBy !== null && $this->finished_by !== $this->asfGuardUserRelatedByFinishedBy->getId()) {
			$this->asfGuardUserRelatedByFinishedBy = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->asfGuardUserRelatedByFinishedBy !== null) {
				if ($this->asfGuardUserRelatedByFinishedBy->isModified() || $this->asfGuardUserRelatedByFinishedBy->isNew()) {
					$affectedRows += $this->asfGuardUserRelatedByFinishedBy->save($con);
				}
				$this->setsfGuardUserRelatedByFinishedBy($this->asfGuardUserRelatedByFinishedBy);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->asfGuardUserRelatedByFinishedBy !== null) {
				if (!$this->asfGuardUserRelatedByFinishedBy->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->asfGuardUserRelatedByFinishedBy->getValidationFailures());
				}
			}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getProtocolId(),
			$keys[6] => $this->getFinishedAt(),
			$keys[7] => $this->getFinishedBy(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setProtocolId($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setFinishedAt($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setFinishedBy($arr[$keys[7]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(JobPeer::ACTIVITY_ID)) $criteria->add(JobPeer::ACTIVITY_ID, $this->activity_id);
		if ($this->isColumnModified(JobPeer::USER_ID)) $criteria->add(JobPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(JobPeer::PROTOCOL_ID)) $criteria->add(JobPeer::PROTOCOL_ID, $this->protocol_id);
		if ($this->isColumnModified(JobPeer::FINISHED_AT)) $criteria->add(JobPeer::FINISHED_AT, $this->finished_at);
		if ($this->isColumnModified(JobPeer::FINISHED_BY)) $criteria->add(JobPeer::FINISHED_BY, $this->finished_by);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setFinishedBy($this->finished_by);
	...
	public function getActivity(PropelPDO $con = null)
	{
		if ($this->aActivity === null && ($this->activity_id !== null)) {
			$this->aActivity = ActivityPeer::retrieveByPk($this->activity_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aActivity->addJobs($this);
			 */
		}
	...
	public function getsfGuardUserRelatedByUserId(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByUserId === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByUserId->addJobsRelatedByUserId($this);
			 */
		}
	 ...
	 * @throws     PropelException
	 */
	public function setsfGuardUserRelatedByFinishedBy(sfGuardUser $v = null)
	{
		if ($v === null) {
			$this->setFinishedBy(NULL);
		} else {
			$this->setFinishedBy($v->getId());
		}

		$this->asfGuardUserRelatedByFinishedBy = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addJobRelatedByFinishedBy($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getsfGuardUserRelatedByFinishedBy(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByFinishedBy === null && ($this->finished_by !== null)) {
			$this->asfGuardUserRelatedByFinishedBy = sfGuardUserPeer::retrieveByPk($this->finished_by);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByFinishedBy->addJobsRelatedByFinishedBy($this);
			 */
		}
		return $this->asfGuardUserRelatedByFinishedBy;
	}
