...
/**
 * Base class that represents a row from the 'rsl_criterias' table.
 *
 * 
 *
 ...
 */
abstract class BaseRslCriteria extends BaseObject  implements Persistent {
	 ...
	 * @return     RslCriteria The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RslCriteriaPeer::ID;
		}
	...
	public function setRslId($v)
	{
		...
		if ($this->rsl_id !== $v) {
			$this->rsl_id = $v;
			$this->modifiedColumns[] = RslCriteriaPeer::RSL_ID;
		}
	...
	public function setProtocolId($v)
	{
		...
		if ($this->protocol_id !== $v) {
			$this->protocol_id = $v;
			$this->modifiedColumns[] = RslCriteriaPeer::PROTOCOL_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = RslCriteriaPeer::NAME;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = RslCriteriaPeer::TYPE;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = RslCriteriaPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = RslCriteriaPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setDeletedAt($v)
	{
		...
		if ( $this->deleted_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = RslCriteriaPeer::DELETED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = RslCriteriaPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = RslCriteriaPeer::UPDATED_BY;
		}
	...
	public function setDeletedBy($v)
	{
		...
		if ($this->deleted_by !== $v) {
			$this->deleted_by = $v;
			$this->modifiedColumns[] = RslCriteriaPeer::DELETED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->rsl_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->protocol_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->name = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->type = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			...
			return $startcol + 11; // 11 = RslCriteriaPeer::NUM_COLUMNS - RslCriteriaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating RslCriteria object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RslCriteriaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseRslCriteria:delete:pre') as $callable)
			{
			...
			if ($ret) {
				RslCriteriaPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseRslCriteria:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseRslCriteria:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(RslCriteriaPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(RslCriteriaPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseRslCriteria:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				RslCriteriaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RslCriteriaPeer::doInsert($this, $con);
					...
					$affectedRows += RslCriteriaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RslCriteriaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RslCriteriaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RslCriteriaPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getRslId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setRslId($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RslCriteriaPeer::ID)) $criteria->add(RslCriteriaPeer::ID, $this->id);
		if ($this->isColumnModified(RslCriteriaPeer::RSL_ID)) $criteria->add(RslCriteriaPeer::RSL_ID, $this->rsl_id);
		if ($this->isColumnModified(RslCriteriaPeer::PROTOCOL_ID)) $criteria->add(RslCriteriaPeer::PROTOCOL_ID, $this->protocol_id);
		if ($this->isColumnModified(RslCriteriaPeer::NAME)) $criteria->add(RslCriteriaPeer::NAME, $this->name);
		if ($this->isColumnModified(RslCriteriaPeer::TYPE)) $criteria->add(RslCriteriaPeer::TYPE, $this->type);
		if ($this->isColumnModified(RslCriteriaPeer::CREATED_AT)) $criteria->add(RslCriteriaPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(RslCriteriaPeer::UPDATED_AT)) $criteria->add(RslCriteriaPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(RslCriteriaPeer::DELETED_AT)) $criteria->add(RslCriteriaPeer::DELETED_AT, $this->deleted_at);
		if ($this->isColumnModified(RslCriteriaPeer::CREATED_BY)) $criteria->add(RslCriteriaPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(RslCriteriaPeer::UPDATED_BY)) $criteria->add(RslCriteriaPeer::UPDATED_BY, $this->updated_by);
		if ($this->isColumnModified(RslCriteriaPeer::DELETED_BY)) $criteria->add(RslCriteriaPeer::DELETED_BY, $this->deleted_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RslCriteriaPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RslCriteria (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RslCriteria Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RslCriteriaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RslCriteriaPeer();
		}
		return self::$peer;
	}
	...
	public function setsfGuardUserRelatedByCreatedBy(sfGuardUser $v = null)
	{
		...
		if ($v !== null) {
			$v->addRslCriteriaRelatedByCreatedBy($this);
		}
	...
	public function getsfGuardUserRelatedByCreatedBy(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUserRelatedByCreatedBy->addRslCriteriasRelatedByCreatedBy($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByUpdatedBy(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addRslCriteriaRelatedByUpdatedBy($this);
		}
	...
	public function getsfGuardUserRelatedByUpdatedBy(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByUpdatedBy->addRslCriteriasRelatedByUpdatedBy($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByDeletedBy(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addRslCriteriaRelatedByDeletedBy($this);
		}
	...
	public function getsfGuardUserRelatedByDeletedBy(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByDeletedBy === null && ($this->deleted_by !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByDeletedBy->addRslCriteriasRelatedByDeletedBy($this);
			 */
		}
	 ...
	 * Otherwise if this RslCriteria has previously been saved, it will retrieve
	 * related StudyUserCriterias from storage. If this RslCriteria is new, it will return
		...
		if ($this->collStudyUserCriterias === null) {
			if ($this->isNew()) {
			   $this->collStudyUserCriterias = array();
				...
				$criteria->add(StudyUserCriteriaPeer::CRITERIA_ID, $this->id);
	 ...
	 * Otherwise if this RslCriteria is new, it will return
	 * an empty collection; or if this RslCriteria has previously
	 * been saved, it will retrieve related StudyUserCriterias from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in RslCriteria.
	 */
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseRslCriteria:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseRslCriteria::%s', $method));
	  }
