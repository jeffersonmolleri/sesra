...
abstract class BaseCityPeer {
	...
	const STATE_ID = 'cities.STATE_ID';

	/** the column name for the SLUG field */
	const SLUG = 'cities.SLUG';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'StateId', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'stateId', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::STATE_ID, self::SLUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'state_id', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'StateId' => 2, 'Slug' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'stateId' => 2, 'slug' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::STATE_ID => 2, self::SLUG => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'state_id' => 2, 'slug' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	/**
	 * Method to DELETE all rows from the cities table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
