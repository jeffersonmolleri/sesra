...
abstract class BaseQuestion extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the answer_type field.
	 * @var        string
	 */
	...
	/**
	 * Get the [answer_type] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [answer_type] column.
	 * 
	 * @param      string $v new value
	 * @return     Question The current object (for fluent API support)
	 */
	public function setAnswerType($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->answer_type !== $v) {
			$this->answer_type = $v;
			$this->modifiedColumns[] = QuestionPeer::ANSWER_TYPE;
		}
	...
	public function setDeletedAt($v)
	{
		...
		if ( $this->deleted_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = QuestionPeer::DELETED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = QuestionPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = QuestionPeer::UPDATED_BY;
		}
	...
	public function setDeletedBy($v)
	{
		...
		if ($this->deleted_by !== $v) {
			$this->deleted_by = $v;
			$this->modifiedColumns[] = QuestionPeer::DELETED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->questionnaire_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->description = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->answer_type = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			return $startcol + 10; // 10 = QuestionPeer::NUM_COLUMNS - QuestionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getQuestionnaireId(),
			$keys[2] => $this->getDescription(),
			$keys[3] => $this->getAnswerType(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setQuestionnaireId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setDescription($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setAnswerType($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(QuestionPeer::ANSWER_TYPE)) $criteria->add(QuestionPeer::ANSWER_TYPE, $this->answer_type);
		...
		if ($this->isColumnModified(QuestionPeer::DELETED_AT)) $criteria->add(QuestionPeer::DELETED_AT, $this->deleted_at);
		if ($this->isColumnModified(QuestionPeer::CREATED_BY)) $criteria->add(QuestionPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(QuestionPeer::UPDATED_BY)) $criteria->add(QuestionPeer::UPDATED_BY, $this->updated_by);
		if ($this->isColumnModified(QuestionPeer::DELETED_BY)) $criteria->add(QuestionPeer::DELETED_BY, $this->deleted_by);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAnswerType($this->answer_type);
	...
	public function setsfGuardUserRelatedByCreatedBy(sfGuardUser $v = null)
	{
		...
		if ($v !== null) {
			$v->addQuestionRelatedByCreatedBy($this);
		}
	...
	public function getsfGuardUserRelatedByCreatedBy(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByCreatedBy->addQuestionsRelatedByCreatedBy($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByUpdatedBy(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addQuestionRelatedByUpdatedBy($this);
		}
	...
	public function getsfGuardUserRelatedByUpdatedBy(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByUpdatedBy->addQuestionsRelatedByUpdatedBy($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByDeletedBy(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addQuestionRelatedByDeletedBy($this);
		}
	...
	public function getsfGuardUserRelatedByDeletedBy(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByDeletedBy === null && ($this->deleted_by !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByDeletedBy->addQuestionsRelatedByDeletedBy($this);
			 */
		}
	 ...
	 */
	public function getAnswersJoinStudy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(QuestionPeer::DATABASE_NAME);
		}
		...
		if ($this->collAnswers === null) {
			if ($this->isNew()) {
				...
				$this->collAnswers = AnswerPeer::doSelectJoinStudy($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
