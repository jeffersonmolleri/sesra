...
abstract class BasesfGuardUserProfilePeer {
	...
	const INSTITUTE = 'sf_guard_user_profile.INSTITUTE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Birthdate', 'Email', 'UserId', 'Institute', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'birthdate', 'email', 'userId', 'institute', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::BIRTHDATE, self::EMAIL, self::USER_ID, self::INSTITUTE, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'birthdate', 'email', 'user_id', 'institute', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Birthdate' => 2, 'Email' => 3, 'UserId' => 4, 'Institute' => 5, 'Description' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'birthdate' => 2, 'email' => 3, 'userId' => 4, 'institute' => 5, 'description' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::BIRTHDATE => 2, self::EMAIL => 3, self::USER_ID => 4, self::INSTITUTE => 5, self::DESCRIPTION => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'birthdate' => 2, 'email' => 3, 'user_id' => 4, 'institute' => 5, 'description' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::INSTITUTE);
