...
abstract class BaseStatePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Code', 'Country', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'code', 'country', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CODE, self::COUNTRY, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'code', 'country', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Code' => 2, 'Country' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'code' => 2, 'country' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CODE => 2, self::COUNTRY => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'code' => 2, 'country' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(CityPeer::STATE_ID, $obj->getId());
