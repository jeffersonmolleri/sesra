...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	public function setInstitute($v)
	{
		...
		if ($this->institute !== $v) {
			$this->institute = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::INSTITUTE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->institute = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setInstitute($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::INSTITUTE)) $criteria->add(sfGuardUserProfilePeer::INSTITUTE, $this->institute);
