...
function form_has_error($form)
{
  return $form->hasErrors();
}

/*function form_error($form, $param, $options = array(), $catalogue = 'messages')
{
  ...
  $style = ($form["{$param_for_sf}"]->renderError() != '' || $form["{$param_for_sf}"]->renderError() != null) ? '' : 'display:none;';
